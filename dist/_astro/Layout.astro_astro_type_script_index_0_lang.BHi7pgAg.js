const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/visual-effects-engine.bVN-MM6R.js","_astro/three.module.C3mHAYDF.js"])))=>i.map(i=>d[i]);
import{_ as A}from"./preload-helper.DhfBKQdW.js";import{T as N,S as q,F as _,P as G,W as U,a as V,B as S,C,b as u,c as M,A as P,d as k,G as W,V as Y,e as j,M as K,f as I,L as X,g as J,h as Q,D as Z}from"./three.module.C3mHAYDF.js";const v={APP_NAME:"Carlos Orbegoso Portfolio",VERSION:"2.0.0",DEBUG:!1,LOGGING:{LEVEL:"warn",SHOW_TIMESTAMPS:!0,SHOW_PREFIX:!0,CONSOLE_OUTPUT:!0},ANIMATIONS:{ENABLED:!0,DURATION:{FAST:200,NORMAL:400,SLOW:800},EASING:{FAST:"ease",NORMAL:"cubic-bezier(0.4, 0, 0.2, 1)",SLOW:"cubic-bezier(0.4, 0, 0.2, 1)"}},THREE_JS:{ENABLED:!0,PERFORMANCE:{MOBILE:"low",TABLET:"medium",DESKTOP:"high"},PARTICLES:{COUNT:{MOBILE:100,TABLET:200,DESKTOP:500}}},LANGUAGES:{DEFAULT:"en",SUPPORTED:["en","es"],FALLBACK:"en"},THEMES:{DEFAULT:"light",SUPPORTED:["light","dark"],AUTO_DETECT:!0},BREAKPOINTS:{MOBILE:768,TABLET:1024,DESKTOP:1200},API:{BASE_URL:"",TIMEOUT:5e3,RETRY_ATTEMPTS:3},NOTIFICATIONS:{AUTO_HIDE:!0,DURATION:5e3,POSITION:"top-right",MAX_VISIBLE:3},SCROLL:{SMOOTH:!0,OFFSET:80,THROTTLE:100},PERFORMANCE:{LAZY_LOADING:!0,DEBOUNCE_DELAY:300,THROTTLE_DELAY:100,CLEANUP_INTERVAL:3e4}};class ee{constructor(){this.prefix="[Portfolio]",this.logLevel="warn"}formatMessage(e,t){const i=new Date().toLocaleTimeString();return`${this.prefix} [${i}] [${e.toUpperCase()}] ${t}`}shouldLog(e){const t={error:0,warn:1,info:2,debug:3};return t[e]<=t[this.logLevel]}error(e,t=null){const i=this.formatMessage("error",e);console.error(i,t)}warn(e,t=null){const i=this.formatMessage("warn",e);console.warn(i,t)}info(e,t=null){if(this.shouldLog("info")){const i=this.formatMessage("info",e);console.info(i,t)}}debug(e,t=null){if(this.shouldLog("debug")){const i=this.formatMessage("debug",e);console.debug(i,t)}}performance(e,t=null){if(this.shouldLog("info")){const i=this.formatMessage("perf",e);console.log(i,t)}}animation(e,t=null){if(this.shouldLog("info")){const i=this.formatMessage("anim",e);console.log(i,t)}}threejs(e,t=null){if(this.shouldLog("info")){const i=this.formatMessage("three",e);console.log(i,t)}}setLogLevel(e){this.logLevel=e}}const y=new ee,L={error:(o,e)=>y.error(o,e),warn:(o,e)=>y.warn(o,e),info:(o,e)=>y.info(o,e),debug:(o,e)=>y.debug(o,e),performance:(o,e)=>y.performance(o,e),animation:(o,e)=>y.animation(o,e),threejs:(o,e)=>y.threejs(o,e),setLogLevel:o=>y.setLogLevel(o)},c={select(o,e=document){return e.querySelector(o)},selectAll(o,e=document){return e.querySelectorAll(o)},create(o,e={},t=""){const i=document.createElement(o);return Object.entries(e).forEach(([s,n])=>{s==="className"?i.className=n:s==="textContent"?i.textContent=n:i.setAttribute(s,n)}),t&&(i.innerHTML=t),i},addClasses(o,...e){o.classList.add(...e)},removeClasses(o,...e){o.classList.remove(...e)},toggleClass(o,e,t){o.classList.toggle(e,t)}},m={on(o,e,t,i={}){o.addEventListener(e,t,i)},off(o,e,t){o.removeEventListener(e,t)},trigger(o,e,t={}){const i=new CustomEvent(e,{detail:t});o.dispatchEvent(i)}},te={debounce(o,e=v.PERFORMANCE.DEBOUNCE_DELAY){let t;return function(...i){clearTimeout(t),t=setTimeout(()=>o.apply(this,i),e)}},throttle(o,e=v.PERFORMANCE.THROTTLE_DELAY){let t=0;return function(...i){const s=Date.now();s-t>=e&&(t=s,o.apply(this,i))}},measureTime(o,e="Function execution"){performance.now();const t=o();return performance.now(),t}},E={light:{mobile:{background:"rgba(255, 255, 255, 0.9)",backdropFilter:"blur(20px)",borderOpacity:.15,shadow:"0 4px 20px rgba(0, 0, 0, 0.12)",borderColor:"rgba(100, 181, 246, 0.15)"},tablet:{background:"rgba(255, 255, 255, 0.6)",backdropFilter:"blur(15px)",borderOpacity:.08,shadow:"0 2px 15px rgba(0, 0, 0, 0.08)",borderColor:"rgba(100, 181, 246, 0.08)"},desktop:{background:"rgba(255, 255, 255, 0.15)",backdropFilter:"blur(6px)",borderOpacity:.02,shadow:"0 1px 8px rgba(0, 0, 0, 0.03)",borderColor:"rgba(100, 181, 246, 0.02)"}},dark:{mobile:{background:"rgba(26, 26, 46, 0.9)",backdropFilter:"blur(20px)",borderOpacity:.2,shadow:"0 4px 20px rgba(0, 0, 0, 0.2)",borderColor:"rgba(79, 195, 247, 0.2)"},tablet:{background:"rgba(26, 26, 46, 0.7)",backdropFilter:"blur(15px)",borderOpacity:.12,shadow:"0 2px 15px rgba(0, 0, 0, 0.15)",borderColor:"rgba(79, 195, 247, 0.12)"},desktop:{background:"rgba(26, 26, 46, 0.25)",backdropFilter:"blur(6px)",borderOpacity:.03,shadow:"0 1px 8px rgba(0, 0, 0, 0.05)",borderColor:"rgba(79, 195, 247, 0.03)"}},breakpoints:{mobile:768,tablet:1024,desktop:1440},transitions:{duration:"0.4s",easing:"cubic-bezier(0.4, 0, 0.2, 1)",header:"all 0.4s cubic-bezier(0.4, 0, 0.2, 1)",theme:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)"},responsive:{mobile:{padding:"var(--spacing-sm) var(--spacing-md)",gap:"var(--spacing-md)",iconSize:"32px",buttonSize:"32px"},tablet:{padding:"var(--spacing-md) var(--spacing-lg)",gap:"var(--spacing-lg)",iconSize:"36px",buttonSize:"36px"},desktop:{padding:"var(--spacing-md) var(--spacing-xl)",gap:"var(--spacing-2xl)",iconSize:"40px",buttonSize:"36px"}}};function ie(o,e){return E[o]?.[e]||E.light.desktop}function z(o,e){const t=o/e;return o<=E.breakpoints.mobile||o<=E.breakpoints.tablet&&t<1.2?"mobile":o<=E.breakpoints.tablet||o<=E.breakpoints.desktop&&t<1.5?"tablet":"desktop"}class se{constructor(){this.deviceType=z(window.innerWidth,window.innerHeight),this.isMobile=this.deviceType==="mobile",this.isTablet=this.deviceType==="tablet",this.isDesktop=this.deviceType==="desktop",this.init()}detectDevice(){return z(window.innerWidth,window.innerHeight)}getTransparencyConfig(){const e=document.documentElement.getAttribute("data-theme")||"light";return ie(e,this.deviceType)}updateHeaderTransparency(){const e=document.querySelector(".header");if(!e)return;const t=this.getTransparencyConfig();e.style.setProperty("--header-bg",t.background),e.style.setProperty("--header-backdrop",t.backdropFilter),e.style.setProperty("--header-border",`1px solid ${t.borderColor}`),e.style.setProperty("--header-shadow",t.shadow),e.style.background=t.background,e.style.backdropFilter=t.backdropFilter,e.style.borderBottom=`1px solid ${t.borderColor}`,e.style.boxShadow=t.shadow}updateThemeTransparency(e){this.updateHeaderTransparency()}handleResize(){const e=this.detectDevice();e!==this.deviceType&&(this.deviceType=e,this.isMobile=this.deviceType==="mobile",this.isTablet=this.deviceType==="tablet",this.isDesktop=this.deviceType==="desktop",this.updateHeaderTransparency())}init(){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{this.setupDeviceDetector()}):this.setupDeviceDetector()}setupDeviceDetector(){this.updateHeaderTransparency(),window.addEventListener("resize",this.handleResize.bind(this)),new MutationObserver(t=>{t.forEach(i=>{if(i.type==="attributes"&&i.attributeName==="data-theme"){const s=document.documentElement.getAttribute("data-theme");this.updateThemeTransparency(s)}})}).observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme"]})}refresh(){this.updateHeaderTransparency()}getDeviceInfo(){return{type:this.deviceType,isMobile:this.isMobile,isTablet:this.isTablet,isDesktop:this.isDesktop,width:window.innerWidth,height:window.innerHeight,ratio:window.innerWidth/window.innerHeight}}}class ne{constructor(){this.menuToggle=null,this.navLinks=null,this.isMenuOpen=!1,this.init()}init(){this.waitForComponents()}waitForComponents(){let t=0;const i=()=>{this.menuToggle=document.getElementById("menu-toggle"),this.navLinks=document.querySelector(".nav-links"),this.menuToggle&&this.navLinks?this.setupEventListeners():(t++,t<50?setTimeout(i,100):console.warn("⚠️ Elementos del menú móvil no encontrados después de múltiples intentos"))};i()}setupEventListeners(){this.menuToggle.addEventListener("click",()=>{this.toggleMenu()}),this.navLinks.addEventListener("click",e=>{e.target.classList.contains("nav-link")&&this.closeMenu()}),document.addEventListener("click",e=>{!this.menuToggle.contains(e.target)&&!this.navLinks.contains(e.target)&&this.closeMenu()}),window.addEventListener("resize",()=>{window.innerWidth>768&&this.closeMenu()})}toggleMenu(){this.isMenuOpen?this.closeMenu():this.openMenu()}openMenu(){this.isMenuOpen=!0,this.menuToggle.classList.add("active"),this.navLinks.classList.add("active"),document.body.style.overflow="hidden"}closeMenu(){this.isMenuOpen=!1,this.menuToggle.classList.remove("active"),this.navLinks.classList.remove("active"),document.body.style.overflow=""}forceClose(){this.closeMenu()}isOpen(){return this.isMenuOpen}}let B=class{constructor(){this.scene=null,this.camera=null,this.renderer=null,this.particles=[],this.constellations=[],this.stars=[],this.titleParticles=null,this.titleGlow=null,this.animationId=null,this.isInitialized=!1,this.currentTheme="light",this.isMobile=window.innerWidth<=768,this.isLowPower=window.innerWidth<=480||navigator.hardwareConcurrency&&navigator.hardwareConcurrency<=4;const e=this.isLowPower?.3:this.isMobile?.5:1;this.config={particles:{count:Math.floor(80*e),size:{min:.3,max:.8},speed:{min:.1,max:.3},opacity:{min:.2,max:.5}},constellations:{count:Math.floor(12*e),starsPerConstellation:{min:3,max:this.isMobile?4:5},starSize:.15,connectionOpacity:.12,connectionWidth:1},stars:{count:Math.floor(100*e),size:{min:.2,max:.6},twinkleSpeed:{min:2,max:5}},titleEffect:{particleCount:Math.floor(150*e),orbitRadius:25,orbitSpeed:.3,particleSize:{min:.15,max:.5}}}}async init(e="hero-particles"){try{return typeof N>"u"?(console.warn("Three.js no está disponible"),!1):(this.setupScene(),this.setupCamera(),this.setupRenderer(e),this.createParticleSystem(),this.createConstellationSystem(),this.createStarSystem(),this.createTitleEffect(),this.setupEventListeners(),this.animate(),this.isInitialized=!0,!0)}catch(t){return console.error("❌ Error inicializando Hero Three.js Engine:",t),!1}}setupScene(){this.scene=new q,this.scene.fog=new _(0,50,200)}setupCamera(){this.camera=new G(75,window.innerWidth/window.innerHeight,.1,1e3),this.camera.position.z=50,this.camera.position.y=0}setupRenderer(e){const t=document.getElementById(e);if(!t){console.warn(`Contenedor ${e} no encontrado`);return}this.renderer=new U({antialias:!0,alpha:!0,powerPreference:"high-performance"}),this.renderer.setSize(t.offsetWidth,t.offsetHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.setClearColor(0,0),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=V,t.appendChild(this.renderer.domElement),this.renderer.domElement.style.position="absolute",this.renderer.domElement.style.top="0",this.renderer.domElement.style.left="0",this.renderer.domElement.style.zIndex="1"}createParticleSystem(){const e=new S,t=this.config.particles.count,i=new Float32Array(t*3),s=new Float32Array(t*3),n=new Float32Array(t),a=new Float32Array(t),r=new Float32Array(t);for(let l=0;l<t;l++){i[l*3]=(Math.random()-.5)*100,i[l*3+1]=(Math.random()-.5)*60,i[l*3+2]=(Math.random()-.5)*50-20;const d=this.currentTheme==="dark"?new C(5227511):new C(6600182);s[l*3]=d.r,s[l*3+1]=d.g,s[l*3+2]=d.b,n[l]=Math.random()*(this.config.particles.size.max-this.config.particles.size.min)+this.config.particles.size.min,a[l]=Math.random()*(this.config.particles.speed.max-this.config.particles.speed.min)+this.config.particles.speed.min,r[l]=Math.random()*(this.config.particles.opacity.max-this.config.particles.opacity.min)+this.config.particles.opacity.min}e.setAttribute("position",new u(i,3)),e.setAttribute("color",new u(s,3)),e.setAttribute("size",new u(n,1)),e.setAttribute("speed",new u(a,1)),e.setAttribute("opacity",new u(r,1));const p=new M({uniforms:{time:{value:0},theme:{value:this.currentTheme==="dark"?1:0}},vertexShader:`
            ...
            `,transparent:!0,blending:P,depthWrite:!1});this.particleSystem=new k(e,p),this.scene.add(this.particleSystem)}createConstellationSystem(){const e=this.config.constellations.count;for(let t=0;t<e;t++){const i=this.createConstellation(t,e);this.constellations.push(i),this.scene.add(i)}}createConstellation(e,t){const i=new W,s=Math.floor(Math.random()*(this.config.constellations.starsPerConstellation.max-this.config.constellations.starsPerConstellation.min)+this.config.constellations.starsPerConstellation.min),n=[],a=this.config.constellations.starSize;for(let l=0;l<s;l++){const d=this.createStar(a,.6),f=l/s*Math.PI*2+Math.random()*.5,h=2+Math.random()*2,w=Math.cos(f)*h,b=Math.sin(f)*h,T=(Math.random()-.5)*1;d.position.set(w,b,T),n.push(new Y(w,b,T)),i.add(d)}for(let l=0;l<s;l++)for(let d=l+1;d<s;d++)if(Math.random()>.3){const f=this.createConnection(n[l],n[d]);i.add(f)}i.position.set((Math.random()-.5)*120,(Math.random()-.5)*70,-15+Math.random()*10);const r=(.08+Math.random()*.12)*(Math.random()>.5?1:-1),p=(.04+Math.random()*.08)*(Math.random()>.5?1:-1);return i.userData={velocity:{x:r,y:p,z:0},rotationSpeed:(Math.random()-.5)*.003,pulsePhase:Math.random()*Math.PI*2,originalScale:1},i}createStar(e,t){const i=new j(e,6,4),s=new K({color:16777215,transparent:!0,opacity:t*.8}),n=new I(i,s);return n.userData={originalIntensity:t*.8,twinkleSpeed:Math.random()*2+1},n}createConnection(e,t){const i=new S().setFromPoints([e,t]),s=new X({color:8965375,transparent:!0,opacity:this.config.constellations.connectionOpacity}),n=new J(i,s);return n.userData={baseOpacity:this.config.constellations.connectionOpacity},n}createTitleEffect(){const e=this.config.titleEffect.particleCount,t=new S,i=new Float32Array(e*3),s=new Float32Array(e*3),n=new Float32Array(e),a=new Float32Array(e),r=new Float32Array(e),p=new Float32Array(e);for(let h=0;h<e;h++){const w=h/e*Math.PI*2*3,b=this.config.titleEffect.orbitRadius+(Math.random()-.5)*15,T=(Math.random()-.5)*12;i[h*3]=Math.cos(w)*b,i[h*3+1]=T,i[h*3+2]=Math.sin(w)*b*.3;const R=.52+Math.random()*.08,x=new C;x.setHSL(R,1,.6+Math.random()*.2),s[h*3]=x.r,s[h*3+1]=x.g,s[h*3+2]=x.b,n[h]=Math.random()*(this.config.titleEffect.particleSize.max-this.config.titleEffect.particleSize.min)+this.config.titleEffect.particleSize.min,a[h]=Math.random()*Math.PI*2,r[h]=.2+Math.random()*.4,p[h]=b}t.setAttribute("position",new u(i,3)),t.setAttribute("color",new u(s,3)),t.setAttribute("size",new u(n,1)),t.setAttribute("phase",new u(a,1)),t.setAttribute("speed",new u(r,1)),t.setAttribute("radius",new u(p,1));const l=new M({uniforms:{time:{value:0}},vertexShader:`
                attribute vec3 color;
                attribute float size;
            ...
            `,transparent:!0,blending:P,depthWrite:!1});this.titleParticles=new k(t,l),this.scene.add(this.titleParticles);const d=new Q(60,20),f=new M({uniforms:{time:{value:0}},vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
            ...
            `,transparent:!0,blending:P,depthWrite:!1,side:Z});this.titleGlow=new I(d,f),this.titleGlow.position.z=-5,this.scene.add(this.titleGlow)}createStarSystem(){const e=new S,t=this.config.stars.count,i=new Float32Array(t*3),s=new Float32Array(t),n=new Float32Array(t);for(let r=0;r<t;r++){const p=Math.acos(-1+2*r/t),l=Math.sqrt(t*Math.PI)*p,d=80+Math.random()*20;i[r*3]=d*Math.cos(l)*Math.sin(p),i[r*3+1]=d*Math.sin(l)*Math.sin(p),i[r*3+2]=d*Math.cos(p),s[r]=Math.random()*(this.config.stars.size.max-this.config.stars.size.min)+this.config.stars.size.min,n[r]=Math.random()*(this.config.stars.twinkleSpeed.max-this.config.stars.twinkleSpeed.min)+this.config.stars.twinkleSpeed.min}e.setAttribute("position",new u(i,3)),e.setAttribute("size",new u(s,1)),e.setAttribute("twinkleSpeed",new u(n,1));const a=new M({uniforms:{time:{value:0}},vertexShader:`
                attribute float size;
                varying float vSize;
        ...
        `,e.style.position="relative",e.appendChild(s);for(let n=0;n<t;n++)this.createExpandingParticle(s,i,n)}createSpiralParticles(e,t,i){const s=document.createElement("div");s.className="spiral-particles",s.style.cssText=`
            ...
            pointer-events: none;
            z-index: 1;
        `,e.style.position="relative",e.appendChild(s);for(let n=0;n<t;n++)this.createSpiralParticle(s,i,n)}createParticle(e,t,i){const s=document.createElement("div");s.className="particle";const n=i/t.count*Math.PI*2,a=60+Math.random()*40,r=Math.random()*t.duration;s.style.cssText=`
            position: absolute;
            width: ${t.size};
            height: ${t.size};
            background: ${t.color};
        ...
        `,e.appendChild(s)}createOrbitalParticle(e,t,i){const s=document.createElement("div");s.className="particle";const n=i/t.count*Math.PI*2,a=40+Math.random()*20,r=t.delay+i*100;s.style.cssText=`
            position: absolute;
            width: ${t.size};
            height: ${t.size};
            background: ${t.color};
        ...
        `,e.appendChild(s)}createSpiralParticle(e,t,i){const s=document.createElement("div");s.className="particle";const n=t.delay+i*200;s.style.cssText=`
            ...
            animation-delay: ${n}ms;
        `,e.appendChild(s)}setupScrollAnimations(){window.addEventListener("scroll",()=>{if(!this.aboutSection||!this.isInitialized)return;const e=this.aboutSection.getBoundingClientRect(),t=(window.innerHeight-e.top)/(window.innerHeight+e.height);t>0&&t<1&&this.updateScrollEffects(t)})}initCounterAnimations(){document.querySelectorAll(".stat-main-number").forEach(t=>{parseInt(t.textContent);const i=t.textContent.replace(/\d/g,""),s=parseInt(t.textContent.replace(/\D/g,""));t.textContent="0"+i;const n=new IntersectionObserver(a=>{a.forEach(r=>{r.isIntersecting&&(this.animateCounter(t,0,s,i),n.unobserve(r.target))})},{threshold:.5});n.observe(t)})}animateCounter(e,t,i,s){const a=performance.now(),r=p=>{const l=p-a,d=Math.min(l/2e3,1),f=1-Math.pow(1-d,4),h=Math.floor(t+(i-t)*f);e.textContent=h+s,e.style.transform=`scale(${1+d*.1})`,e.style.color=`hsl(${200+d*60}, 70%, ${60+d*20}%)`,d<1?requestAnimationFrame(r):(e.style.transform="scale(1)",e.style.color="",this.createCelebrationEffect(e))};requestAnimationFrame(r)}createCelebrationEffect(e){const t=e.parentElement,i=document.createElement("div");i.className="celebration-particles",i.style.cssText=`
            position: absolute;
            top: 50%;
            left: 50%;
        ...
        `,document.head.appendChild(this.style)}playSound(){try{const e=new(window.AudioContext||window.webkitAudioContext),t=e.createOscillator(),i=e.createGain();t.connect(i),i.connect(e.destination),t.frequency.setValueAtTime(587.33,e.currentTime),t.frequency.setValueAtTime(880,e.currentTime+.1),t.frequency.setValueAtTime(1174.66,e.currentTime+.2),i.gain.setValueAtTime(.3,e.currentTime),i.gain.exponentialRampToValueAtTime(.01,e.currentTime+.5),t.start(e.currentTime),t.stop(e.currentTime+.5)}catch{}}setupAutoClose(){setTimeout(()=>{document.body.contains(this.overlay)&&this.close()},5e3)}close(){this.overlay&&(this.overlay.style.animation="konamiFadeOut 0.3s ease forwards",setTimeout(()=>{this.overlay?.remove(),this.style?.remove(),this.overlay=null,this.style=null},300))}}let O=null,F=null,D=null;class le{constructor(){this.visualEngine=null,this.brainEngine=null,this.neuralBackground=null,this.heroEngine=null,this.cursorEngine=null,this.deviceDetector=null,this.mobileMenuManager=null,this.heroAnimations=null,this.aboutAnimations=null,this.konamiEasterEgg=null,this.isInitialized=!1,this.modules=new Map}async init(){try{await this.initializeBasicModules(),this.setupBasicFeatures(),await this.initializeAdvancedModules(),this.setupGlobalEvents(),this.isInitialized=!0,L.info("Portfolio initialized")}catch(e){console.error("Error initializing portfolio:",e)}}async initializeBasicModules(){this.deviceDetector=new se,this.mobileMenuManager=new ne,this.heroAnimations=new H,this.aboutAnimations=new ae,this.konamiEasterEgg=new re}async initializeAdvancedModules(){const e=window.innerWidth<=768,t=window.innerWidth<=480||navigator.hardwareConcurrency&&navigator.hardwareConcurrency<=4;if(!e)try{O=(await A(()=>import("./visual-effects-engine.bVN-MM6R.js"),__vite__mapDeps([0,1]))).VisualEffectsEngine,this.visualEngine=new O;const s=localStorage.getItem("theme")||v.THEMES.DEFAULT;this.visualEngine.updateTheme(s),this.initializeSectionEffects()}catch(i){L.error("Error initializing visual engine:",i)}if(!t)try{F=(await A(()=>Promise.resolve().then(()=>oe),void 0)).HeroThreeEngine,this.heroEngine=new F,await this.heroEngine.init("hero-particles")}catch(i){L.error("Error initializing Hero Three.js Engine:",i)}if(!e)try{D=(await A(()=>import("./cursor-particles-engine.CtQFKbK1.js"),[])).CursorParticlesEngine,this.cursorEngine=new D}catch(i){console.error("Error initializing Cursor Particles Engine:",i)}}initializeSectionEffects(){if(!this.visualEngine)return;[{name:"Hero",containerId:"hero-effects"},{name:"About",containerId:"about-effects"},{name:"Experience",containerId:"experience-effects"},{name:"Skills",containerId:"skills-effects"},{name:"Projects",containerId:"projects-effects"},{name:"Contact",containerId:"contact-effects"}].forEach(t=>{document.getElementById(t.name.toLowerCase())&&this.visualEngine.initSectionEffects(t.name,t.containerId)}),this.setupSectionEffectsObserver()}setupSectionEffectsObserver(){const e=["hero","about","experience","skills","projects","contact"],t=new IntersectionObserver(i=>{i.forEach(s=>{s.isIntersecting&&s.target.classList.add("section-effects-active")})},{threshold:.1,rootMargin:"0px 0px -100px 0px"});e.forEach(i=>{const s=document.getElementById(i);s&&t.observe(s)})}setupBasicFeatures(){this.setupThemeToggle(),this.setupMobileMenu(),this.setupSmoothScrolling(),this.setupLanguageToggle(),this.setupMobileOptimizations(),this.setupTouchInteractions()}setupThemeToggle(){const e=c.select("#theme-toggle");if(!e)return;const t=localStorage.getItem("theme")||v.THEMES.DEFAULT;document.documentElement.setAttribute("data-theme",t),this.updateThemeIcon(t),m.on(e,"click",()=>{const i=document.documentElement.getAttribute("data-theme")==="light"?"dark":"light";document.documentElement.setAttribute("data-theme",i),localStorage.setItem("theme",i),this.updateThemeIcon(i),this.visualEngine&&this.visualEngine.updateTheme(i),this.heroEngine&&this.heroEngine.updateTheme(i),this.neuralBackground&&this.neuralBackground.updateTheme(i),m.trigger(window,"themeChanged",{theme:i})})}updateThemeIcon(e){const t=c.select("#theme-toggle i");t&&(t.className=e==="light"?"fas fa-moon":"fas fa-sun")}setupMobileMenu(){const e=c.select("#menu-toggle"),t=c.select(".cosmic-nav")||c.select(".nav-links");!e||!t||(m.on(e,"click",()=>{c.toggleClass(t,"active"),c.toggleClass(e,"active"),document.body.style.overflow=t.classList.contains("active")?"hidden":""}),c.selectAll(".nav-link, .cosmic-link").forEach(i=>{m.on(i,"click",()=>{c.removeClasses(t,"active"),c.removeClasses(e,"active"),document.body.style.overflow=""})}),m.on(document,"click",i=>{!e.contains(i.target)&&!t.contains(i.target)&&(c.removeClasses(t,"active"),c.removeClasses(e,"active"),document.body.style.overflow="")}))}setupSmoothScrolling(){c.selectAll('a[href^="#"]').forEach(e=>{m.on(e,"click",t=>{t.preventDefault();const i=c.select(e.getAttribute("href"));i&&i.scrollIntoView({behavior:"smooth",block:"start"})})})}setupLanguageToggle(){const e=c.select("#language-toggle");if(!e)return;const t=localStorage.getItem("language")||v.LANGUAGES.DEFAULT;document.documentElement.setAttribute("data-language",t),m.on(e,"click",()=>{const i=localStorage.getItem("language")==="en"?"es":"en";localStorage.setItem("language",i),document.documentElement.setAttribute("data-language",i),m.trigger(window,"languageChanged",{language:i})})}setupMobileOptimizations(){/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)&&c.addClasses(document.body,"mobile-device"),window.innerWidth<=v.BREAKPOINTS.TABLET&&window.innerWidth>v.BREAKPOINTS.MOBILE&&c.addClasses(document.body,"tablet-device")}setupTouchInteractions(){c.selectAll(".btn, .tech-badge, .nav-link, .card").forEach(t=>{m.on(t,"touchstart",()=>{t.style.transform="scale(0.95)"}),m.on(t,"touchend",()=>{t.style.transform=""}),m.on(t,"touchcancel",()=>{t.style.transform=""})})}setupGlobalEvents(){m.on(document,"visibilitychange",()=>{}),m.on(window,"resize",te.throttle(()=>{},100)),m.on(document,"keydown",e=>{if(e.key==="Escape"){const t=c.select(".cosmic-nav")||c.select(".nav-links"),i=c.select("#menu-toggle");t?.classList.contains("active")&&(c.removeClasses(t,"active"),c.removeClasses(i,"active"),document.body.style.overflow="")}e.key==="t"&&e.ctrlKey&&(e.preventDefault(),c.select("#theme-toggle")?.click()),this.konamiEasterEgg&&this.konamiEasterEgg.handleKeyPress(e.key)})}}class ce{constructor(){this.progressBar=document.getElementById("loader-progress-bar"),this.progressValue=document.querySelector(".loader-progress-value"),this.statusText=document.querySelector(".loader-status"),this.currentProgress=0,this.targetProgress=0,this.isComplete=!1,this.stages=[{progress:15,status:"Loading assets..."},{progress:35,status:"Initializing..."},{progress:55,status:"Loading modules..."},{progress:75,status:"Preparing UI..."},{progress:90,status:"Almost ready..."},{progress:100,status:"Complete!"}]}updateProgress(e){this.targetProgress=Math.min(e,100),this.animateProgress()}animateProgress(){if(this.currentProgress<this.targetProgress){this.currentProgress+=Math.max(1,(this.targetProgress-this.currentProgress)*.1),this.currentProgress>=this.targetProgress-.5&&(this.currentProgress=this.targetProgress);const e=Math.round(this.currentProgress);this.progressBar&&(this.progressBar.style.width=`${e}%`),this.progressValue&&(this.progressValue.textContent=`${e}%`),this.updateStatus(e),this.currentProgress<this.targetProgress&&requestAnimationFrame(()=>this.animateProgress())}}updateStatus(e){if(this.statusText){for(let t=this.stages.length-1;t>=0;t--)if(e>=this.stages[t].progress-10){this.statusText.textContent=this.stages[t].status;break}}}complete(){this.isComplete=!0,this.updateProgress(100)}hide(){const e=document.getElementById("page-loader");e&&(e.classList.add("loaded"),setTimeout(()=>{e.style.display="none"},800))}}const g=new ce;setTimeout(()=>g.updateProgress(15),100);setTimeout(()=>g.updateProgress(35),400);setTimeout(()=>g.updateProgress(55),800);const $=()=>{g.complete(),setTimeout(()=>g.hide(),400)},de=()=>{const o=document.querySelector("[data-header-progress]");o&&window.addEventListener("scroll",()=>{const e=window.scrollY,t=document.documentElement.scrollHeight-window.innerHeight,i=e/t*100;o.style.width=`${i}%`})},he=()=>{const o=document.getElementById("contact-form");o&&o.addEventListener("submit",async e=>{e.preventDefault();const t=o.querySelector('button[type="submit"]'),i=t.innerHTML;t.innerHTML='<i class="fas fa-spinner fa-spin"></i> Sending...',t.disabled=!0,await new Promise(s=>setTimeout(s,1500)),t.innerHTML='<i class="fas fa-check"></i> Sent!',o.reset(),setTimeout(()=>{t.innerHTML=i,t.disabled=!1},2e3)})};document.addEventListener("DOMContentLoaded",async()=>{g.updateProgress(60);const o=new le;g.updateProgress(75),await o.init(),g.updateProgress(90),window.portfolio=o,de(),he(),g.updateProgress(100),setTimeout($,600)});window.addEventListener("load",()=>{g.isComplete||(g.updateProgress(100),setTimeout($,800))});
